...
{
    public class BlushPaletteCell : MonoBehaviour, IPaletteCell, IPointerClickHandler
    {
        [SerializeField] private BlushColor _color;
        [SerializeField] private BlushBrush _brush;
        [SerializeField] private Hand _hand;

        public Vector3 WorldPosition => transform.position;
        public BaseTool CorrespondingTool => _brush;

        /// <summary>Applies this cell's blush color to the brush.</summary>
